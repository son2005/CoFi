...
*/
// https://app.codesignal.com/challenge/npkv8LZLjQCA48AGX
// function marathonTaskScore(marathonLength, maxScore, submissions, successfulSubmissionTime) {
//     if(!~successfulSubmissionTime) return 0
//     return Math.max(halfScore = maxScore / 2, maxScore - (halfScore / marathonLength * successfulSubmissionTime + 10 * (submissions - 1)))
// }

marathonTaskScore = (l, m, s, t) => ~t ? Math.max(h=m/2, m - (h*t/l + 10*s-10)) : 0
