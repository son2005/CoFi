...
*/
-- https://app.codesignal.com/arcade/db/between-join-and-select/gttNbwKXyN9i8nvYD
CREATE PROCEDURE filmLibrary()
SELECT a.*
    FROM movies m
    JOIN starring_actors s ON s.movie_name = m.movie
    JOIN actor_ages a USING(actor)
