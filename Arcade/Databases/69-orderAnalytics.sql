...
4	2016	4	Cake	49
*/
-- https://app.codesignal.com/arcade/db/express-your-creativity/uk2oaFYGfFzb4u3XX/solutions
DROP PROCEDURE IF EXISTS orderAnalytics;
CREATE PROCEDURE orderAnalytics()
BEGIN

    CREATE OR REPLACE VIEW order_analytics AS
    SELECT id, YEAR(order_date), QUARTER(order_date), type, (quantity * price) total_price
    FROM orders;
